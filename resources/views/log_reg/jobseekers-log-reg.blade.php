...
<div class="container" id="container">
    ...
    <form method="POST" action="{{ route('job_seekers_register') }}" class=" mb-5 login-input">
        @csrf 
            ...
            <input type="number" class="form-control" placeholder="Phn_no" name="phone_number"  >
	...
	<div class="form-container sign-in-container">
		  ...
		  <form method="POST" action="{{ route('jobseekersdashboard') }}" class="mt-5 mb-5 login-input">
        @csrf 
